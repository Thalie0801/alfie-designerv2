    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-4 right-4 rounded-full shadow-lg w-12 h-12 grid place-items-center hover:scale-105 transition"
      ...
      {open && (
        <div
          className="fixed bottom-4 right-4 w-[360px] max-w-[95vw] h-[520px] rounded-2xl shadow-2xl border flex flex-col"
