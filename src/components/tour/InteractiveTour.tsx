...
const DASHBOARD_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "🐶 Tes Woofs",
    content: "Les Woofs sont la monnaie d'Alfie. Chaque image = 1 Woof, carrousel = 1 Woof/slide, vidéo standard 4s = 10 Woofs, vidéo premium 8s = 50 Woofs. Ils se rechargent chaque mois.",
    placement: "top",
  },
  {
