...
const DEFAULT_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Accès rapide à vos outils : visuel, vidéo, bibliothèque et templates.',
    placement: 'top',
  },
  {
    selector: '[data-tour-id="quotas"]',
    title: '📊 Vos quotas',
    content: 'Suivez votre utilisation mensuelle : images, vidéos et crédits Alfie restants.',
    placement: 'top',
  },
  {
  ...
  },
  {
    ...
    content: 'Créez une nouvelle marque avec son identité visuelle complète.',
    placement: 'left',
  },
  {
    selector: '[data-tour-id="news"]',
    title: '📰 Actualités',
    content: 'Restez informé des dernières nouveautés et mises à jour d\'Alfie.',
    placement: 'bottom',
  },
  {
    selector: '[data-tour-id="suggest"]',
    title: '💡 Suggérer une fonctionnalité',
    content: 'Proposez vos idées pour améliorer Alfie Designer.',
    placement: 'bottom',
  },
  {
    selector: '[data-sidebar-id="library"]',
    title: '📚 Bibliothèque',
    content: 'Retrouvez toutes vos créations sauvegardées dans votre bibliothèque.',
    placement: 'right',
  },
  {
