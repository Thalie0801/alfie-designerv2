...
/** --- ChatWidget inline (pas de nouveau fichier, guidance uniquement) --- */
function ChatWidget() {
      ...
      {open && (
        <div className="fixed bottom-4 right-4 z-50 w-[360px] max-w-[95vw] h-[520px] rounded-2xl shadow-2xl border bg-white flex flex-col">
          ...
          <div className="flex-1 overflow-auto p-3 space-y-3">
            {/* Ici tu peux monter ton composant de chat, en "mode guidance".
                Important: aucune action de génération ne part d’ici. */}
